...
```mermaid
graph TD
    TOFU["TOFU - Top of Funnel\n(Nhận biết - Awareness)"] --> MOFU["MOFU - Middle of Funnel\n(Cân nhắc - Consideration)"]
    MOFU --> BOFU["BOFU - Bottom of Funnel\n(Quyết định - Decision)"]
    BOFU --> LOYAL["Loyalty Loop\n(Trung thành - Advocate)"]
```
...
```mermaid
graph TD
    A[Điểm mạnh của thương hiệu] --> D{USP}
    B[Nhu cầu chưa được đáp ứng của khách hàng] --> D
    C[Khoảng trống của đối thủ cạnh tranh] --> D
```
...
mindmap
  root((Module 1\nNền tảng Content Marketing))
    ...
    Loại hình Content
      ...
      UGC
    USP
      3 vòng tròn giao nhau
      Bộ câu hỏi xác định USP
```
