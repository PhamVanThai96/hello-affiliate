...
```mermaid
graph TD
    P[PILLAR PAGE\nVD: Hướng dẫn chăm sóc da toàn diện] --> C1[Cluster: Chăm sóc da dầu mụn]
    P --> C2[Cluster: Chăm sóc da khô]
    P --> C3[Cluster: Skincare routine buổi sáng]
    P --> C4[Cluster: Skincare routine buổi tối]
    P --> C5[Cluster: Thành phần cần tránh trong mỹ phẩm]
    C1 -.liên kết nội bộ.- P
    C2 -.liên kết nội bộ.- P
    C3 -.liên kết nội bộ.- P
```
...
mindmap
  root((Module 2\nChiến lược Nội dung))
    Buyer Persona
      8 thành phần Persona Canvas
      Nguồn dữ liệu thực tế
    Customer Journey Map
      5 giai đoạn
      Touchpoint và Content tương ứng
    Content Pillar và Cluster
      5 bước xây dựng
      Liên kết SEO nội bộ
    Content Mix 3H
      Hero
